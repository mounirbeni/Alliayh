    ...
    <div className={cn(
      ...
      <Link href={`/products/${product.id}`} className="relative aspect-[4/5] overflow-hidden m-5 rounded-[2.5rem]">
        ...
        <div className="absolute inset-x-6 bottom-6 flex gap-3 translate-y-16 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-700 delay-100">
           <Button className="flex-1 rounded-full bg-white/95 dark:bg-primary/90 dark:text-white backdrop-blur-md text-primary hover:bg-primary hover:text-white border-none font-body uppercase tracking-[0.3em] text-[9px] h-14 font-bold shadow-2xl">
             Add to Aura
           </Button>
