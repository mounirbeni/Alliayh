 ...
 * through `@/lib/catalog` on the server, and authentication is handled by
 * `@/lib/auth`. What remains is the work that is genuinely asynchronous and not
 * yet backed by a service.
 */
